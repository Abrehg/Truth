...
class VarietySpider(scrapy.Spider):
    ...
    start_urls = [
        ...
        "https://variety.com/c/global/",
        "https://variety.com/e/contenders/",
    ]
    ...
    def __init__(self, *args, **kwargs):
        super(VarietySpider, self).__init__(*args, **kwargs)
        self.visited_urls = set()

    def parse(self, response):
        # Extract news links from the start page and section links
        news_links = response.css("a.lb-tile-link::attr(href)")
